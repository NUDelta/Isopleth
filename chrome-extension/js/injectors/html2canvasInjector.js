    ...
    return function () {
      ...
      (function (window, document, exports, global, define, undefined) {
        ...
        if (typeof(document) === "undefined" || typeof(Object.create) !== "function" || typeof(document.createElement("canvas").getContext) !== "function") {
          window.unravelAgent.html2canvas = function () {
        ...
        window.unravelAgent.html2canvas = function (nodeList, options) {
          var index = html2canvasCloneIndex++;
          options = options || {};
          if (options.logging) {
            window.unravelAgent.html2canvas.logging = true;
            window.unravelAgent.html2canvas.start = Date.now();
          }
        ...
        window.unravelAgent.html2canvas.punycode = this.punycode;
        window.unravelAgent.html2canvas.proxy = {};
...
// JSON.stringify([].slice.call($$('.named-color-table tr'), 1).map(function(row) { return [row.childNodes[3].textContent, row.childNodes[5].textContent.trim().split(",").map(Number)] }).reduce(function(data, row) {data[row[0]] = row[1]; return data}, {}))
        ...
        function FrameContainer(container, sameOrigin, options) {
          ...
          this.promise = (!sameOrigin ? this.proxyLoad(options.proxy, bounds, options) : new Promise(function (resolve) {
            ...
            return unravelAgent.html2canvas(container.contentWindow.document.documentElement, {
              type: 'view',
        ...
        function log() {
          if (window.unravelAgent.html2canvas.logging && window.console && window.console.log) {
            Function.prototype.bind.call(window.console.log, (window.console)).apply(window.console, [(Date.now() - window.unravelAgent.html2canvas.start) + "ms", "unravelAgent.html2canvas:"].concat([].slice.call(arguments, 0)));
          }
        }
        ...
        NodeParser.prototype.paintText = function (container) {
          ...
          var characters = window.unravelAgent.html2canvas.punycode.ucs2.decode(container.node.data);
          var textList = (!this.options.letterRendering || noLetterSpacing(container)) && !hasUnicode(container.node.data) ? getWords(characters) : characters.map(function (character) {
              return window.unravelAgent.html2canvas.punycode.ucs2.encode([character]);
            });
        ...
        function getWords(characters) {
          ...
          while (characters.length) {
            if (isWordBoundary(characters[i]) === onWordBoundary) {
              ...
              if (word.length) {
                words.push(window.unravelAgent.html2canvas.punycode.ucs2.encode(word));
              }
        ...
        function jsonp(document, url, callback) {
          return new Promise(function (resolve, reject) {
            ...
            var cleanup = function () {
              delete window.unravelAgent.html2canvas.proxy[callback];
              document.body.removeChild(s);
            };
            window.unravelAgent.html2canvas.proxy[callback] = function (response) {
              cleanup();
              resolve(response);
            };
            s.src = url;
        ...
        function createProxyUrl(proxyUrl, src, callback) {
          return proxyUrl + "?url=" + encodeURIComponent(src) + (callback.length ? "&callback=unravelAgent.html2canvas.proxy." + callback : "");
        }
        ...
        function SVGContainer(src) {
          ...
          this.promise = this.hasFabric().then(function () {
            ...
            return new Promise(function (resolve) {
              unravelAgent.html2canvas.fabric.loadSVGFromString(svg, self.createCanvas.call(self, resolve));
            });
          });
        }

        SVGContainer.prototype.hasFabric = function () {
          return !unravelAgent.html2canvas.fabric ? Promise.reject(new Error("html2canvas.svg.js is not loaded, cannot render svg")) : Promise.resolve();
        };
        ...
        SVGContainer.prototype.createCanvas = function (resolve) {
          ...
          return function (objects, options) {
            var canvas = new unravelAgent.html2canvas.fabric.StaticCanvas('c');
            self.image = canvas.lowerCanvasEl;
            canvas
              .setWidth(options.width)
              .setHeight(options.height)
              .add(unravelAgent.html2canvas.fabric.util.groupSVGElements(objects, options))
              .renderAll();
        ...
        function SVGNodeContainer(node, native) {
          ...
          this.promise = native ? new Promise(function (resolve, reject) {
              ...
              return new Promise(function (resolve) {
                unravelAgent.html2canvas.fabric.parseSVGDocument(node, self.createCanvas.call(self, resolve));
              });
            });
        }
